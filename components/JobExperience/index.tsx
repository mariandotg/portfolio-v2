...
const JobExperience = () => {
  ...
  return (
    <Section>
        ...
        {data.content.jobCards.map((jobCard) => {
          return (
            ...
            >
              ...
              >
                <span className='dark:hover:text-primary hover:text-primary tablet:cursor-pointer flex tablet:p-4 rounded tablet:border-[1px] tablet:border-transparent tablet:hover:border-primary tablet:dark:hover:border-primary font-light text-light-text dark:text-dark-text'>
                  {jobCard.period}
                </span>
              </div>
              <div className='flex tablet:hidden tablet:pb-8 tablet:border-none flex-col gap-y-2 tablet:col-span-2 before:content-[""] before:rounded before:w-[7px] before:h-[7px] before:bg-primary before:absolute before:top-1 before:right-auto tablet:relative tablet:before:-left-5 before:-left-1'>
      ...
      {displayedJob && (
        <div className='h-[260px] hidden tablet:flex tablet:pb-8 tablet:border-none flex-col gap-y-2 tablet:col-span-2 before:content-[""] before:rounded before:w-[7px] before:h-[7px] before:bg-primary before:absolute before:top-1 before:right-auto tablet:relative tablet:before:-left-5 before:-left-1'>
          <h3 className='flex font-medium gap-x-4 dark:text-dark-headlines text-title font-display text-light-headlines'>
